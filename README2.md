...
REST Service para acceso a listas externas para uso de la CNC2, tales como:
...
2) Ubicados sobre el proyecto maven tipeamos
	$>mvn clean package
	Esto genera un archivo war en "ServiciosRemotos\targeto\ServiciosRemotos.war"
3) Deployar el archivo "ServiciosRemotos.war" generado, para ello
